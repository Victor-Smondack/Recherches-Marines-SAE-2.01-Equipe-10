...
public class Controleur
{
    ...
    // Méthode de triche pour le mode Présentation / Debug afin de forcer une carte précise
    public void forcerCarteDebug( String espece, String couleur )
    {
        if ( this.pioche != null && !this.pioche.estVide() )
        {
            this.pioche.piocher();
        }

        String imagePath = espece + couleur + ".png";
        if ( espece.equals( "Joker" ) )
        {
            imagePath = "Joker" + couleur + ".png";
        }

        this.carteVisible      = new src.metier.Carte( -1, espece, couleur, imagePath );
        this.aJoueCeTour       = false;
        this.selectedExtremity = null;
