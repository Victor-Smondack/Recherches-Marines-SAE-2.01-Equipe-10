...
public class Controleur
{
    ...
    *********************************************************/
    ...
    // Lance le jeu en initialisant les vues et la pioche
    ...
    /*********************************************************
    * Gestion de la Pioche et des Cartes         *
    *********************************************************/
    ...
    /*********************************************************
    * Règles de Gameplay & Actions Joueur        *
    *********************************************************/
    ...
    // Vérifie la validité d'un déplacement d'une extrémité vers une destination
    ...
    // Valide et applique le déplacement choisi par le joueur depuis une extrémité
    ...
    *********************************************************/
    ...
    // Récupère le nom du dossier choisi pour lire les fichiers de configuration
    ...
    /*********************************************************
    * IHM & Gestion Graphique (Couleurs/Affichage)   *
    *********************************************************/
    ...
    // Demande le rafraîchissement graphique de la table de jeu
    public void majIHM()
    {
