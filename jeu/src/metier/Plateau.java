...
public class Plateau
{
    ...
    *********************************************************/
    ...
    /*********************************************************
    * Lecture de Fichier & Initialisation        *
    *********************************************************/

    // Charge dynamiquement les données depuis le dossier sélectionné
        ...
        } else
        {
            if ( this.progressionLabo != null )
            {
                ...
                } else
                {
                    ...
                    {
                        if ( l2 != null && !this.croiseUneLiaisonVisitee( l2 ) )
                        {
